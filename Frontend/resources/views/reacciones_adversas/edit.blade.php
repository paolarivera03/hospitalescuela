...
<div class="container py-2">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h3 class="mb-0 fw-black" style="font-weight:900;">
                ...
                Editar Reacción Adversa #{{ $reaccion['id_reaccion'] ?? '' }}
            </h3>
    ...
    <div class="form-card p-4">
        <form id="formCrearRAM"
              method="POST"
                            action="{{ route('reacciones_adversas.update', $reaccion['id_reaccion']) }}"
              enctype="multipart/form-data"
              data-unsaved-form="true">
            @csrf
                        @method('PUT')
                        <input type="hidden" name="id_paciente" id="id_paciente" value="{{ old('id_paciente', $reaccion['id_paciente'] ?? '') }}">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="p_numero_expediente" class="form-control" value="{{ old('numero_expediente', $reaccion['numero_expediente'] ?? 'GENERADO AUTOMATICAMENTE') }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="p_nombre" name="paciente_nombre" class="form-control mayusculas texto-general no-repetidos @error('paciente_nombre') is-invalid @enderror" value="{{ old('paciente_nombre', $reaccion['nombre_completo'] ?? '') }}">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" id="p_edad" name="paciente_edad" min="1" max="99" class="form-control @error('paciente_edad') is-invalid @enderror" value="{{ old('paciente_edad', $reaccion['edad'] ?? '') }}">
                                @error('paciente_edad')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <select id="p_sexo" name="paciente_sexo" class="form-select @error('paciente_sexo') is-invalid @enderror">
                                    ...
                                    <option value="M" {{ old('paciente_sexo', $reaccion['sexo'] ?? '') === 'M' ? 'selected' : '' }}>MASCULINO</option>
                                    <option value="F" {{ old('paciente_sexo', $reaccion['sexo'] ?? '') === 'F' ? 'selected' : '' }}>FEMENINO</option>
                                    <option value="Otro" {{ old('paciente_sexo', $reaccion['sexo'] ?? '') === 'Otro' ? 'selected' : '' }}>OTRO</option>
                                </select>
                                @error('paciente_sexo')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="p_diagnostico" name="diagnostico_ingreso" rows="2" class="form-control mayusculas texto-general no-repetidos @error('diagnostico_ingreso') is-invalid @enderror">{{ old('diagnostico_ingreso', $reaccion['diagnostico'] ?? '') }}</textarea>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                ...
                                <select id="notificador" name="notificador" class="form-select @error('notificador') is-invalid @enderror" required>
                                    <option value="">Seleccione</option>
                                    <option value="MEDICO" {{ old('notificador', $notificadorActual ?? 'MEDICO') === 'MEDICO' ? 'selected' : '' }}>MEDICO</option>
                                    <option value="ENFERMERO" {{ old('notificador', $notificadorActual ?? 'MEDICO') === 'ENFERMERO' ? 'selected' : '' }}>ENFERMERO</option>
                                    <option value="FARMACEUTICO" {{ old('notificador', $notificadorActual ?? 'MEDICO') === 'FARMACEUTICO' ? 'selected' : '' }}>FARMACEUTICO</option>
                                </select>
                                @error('notificador')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-8 position-relative">
                                ...
                                <input type="text"
                                       ...
                                       autocomplete="off"
                                        value="{{ old('buscarMedico', $reaccion['nombre_medico'] ?? '') }}"
                                       required>
                                    <input type="hidden" id="id_medico" name="id_medico" value="{{ old('id_medico', $reaccion['id_medico'] ?? '') }}">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" id="p_sala" name="sala" class="form-control mayusculas texto-general no-repetidos @error('sala') is-invalid @enderror" value="{{ old('sala', $reaccion['sala'] ?? '') }}" required>
                                @error('sala')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="p_numero_cama" name="numero_cama" class="form-control mayusculas texto-general no-repetidos @error('numero_cama') is-invalid @enderror" value="{{ old('numero_cama', $reaccion['numero_cama'] ?? '') }}" required>
                                @error('numero_cama')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <div class="col-md-5 position-relative">
                            ...
                            <input type="text" id="buscarMedicamento" name="medicamento_nombre" class="form-control mayusculas texto-general no-repetidos" placeholder="Buscar medicamento..." autocomplete="off" value="{{ old('medicamento_nombre', $detalles[0]['medicamento'] ?? $detalles[0]['nombre_comercial'] ?? '') }}" required>
                            <input type="hidden" name="id_medicamento" id="id_medicamento" value="{{ old('id_medicamento', $detalles[0]['id_medicamento'] ?? '') }}">
                        ...
                        <div class="col-md-3 position-relative">
                            ...
                            <input type="text" id="buscarLote" class="form-control mayusculas texto-general no-repetidos" placeholder="Buscar lote..." autocomplete="off" value="{{ old('buscarLote', $detalles[0]['numero_lote'] ?? '') }}" required>
                            <input type="hidden" name="id_lote" id="id_lote" value="{{ old('id_lote', $detalles[0]['id_lote'] ?? '') }}">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="dosis_posologia" id="dosis_posologia" class="form-control mayusculas texto-general no-repetidos" value="{{ old('dosis_posologia', $detalles[0]['dosis_posologia'] ?? '') }}" placeholder="Ej: 500MG" required>
                        </div>

                        <div class="col-md-2">
                            <label class="form-label">Vía <span class="text-danger">*</span></label>
                            <input type="text" name="via_administracion" id="via_administracion" class="form-control mayusculas texto-general no-repetidos" value="{{ old('via_administracion', $detalles[0]['via_administracion'] ?? '') }}" placeholder="ORAL / IV" required>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" name="fecha_inicio_uso" id="fecha_inicio_uso" class="form-control" value="{{ old('fecha_inicio_uso', !empty($detalles[0]['fecha_inicio_uso']) ? \Carbon\Carbon::parse($detalles[0]['fecha_inicio_uso'])->toDateString() : '') }}" max="{{ now()->toDateString() }}" required>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label">Fin uso (opcional)</label>
                            <input type="date" name="fecha_fin_uso" id="fecha_fin_uso" class="form-control" value="{{ old('fecha_fin_uso', !empty($detalles[0]['fecha_fin_uso']) ? \Carbon\Carbon::parse($detalles[0]['fecha_fin_uso'])->toDateString() : '') }}" min="{{ old('fecha_inicio_uso', !empty($detalles[0]['fecha_inicio_uso']) ? \Carbon\Carbon::parse($detalles[0]['fecha_inicio_uso'])->toDateString() : '') }}">
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date"
                                ...
                                value="{{ old('fecha_inicio_reaccion', !empty($reaccion['fecha_inicio_reaccion']) ? \Carbon\Carbon::parse($reaccion['fecha_inicio_reaccion'])->toDateString() : '') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date"
                                ...
                                value="{{ old('fecha_fin_reaccion', !empty($reaccion['fecha_fin_reaccion']) ? \Carbon\Carbon::parse($reaccion['fecha_fin_reaccion'])->toDateString() : '') }}"
                                min="{{ old('fecha_inicio_reaccion', !empty($reaccion['fecha_inicio_reaccion']) ? \Carbon\Carbon::parse($reaccion['fecha_inicio_reaccion'])->toDateString() : '') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <select
                                ...
                                @foreach(($desenlaceOptions ?? []) as $option)
                                    <option value="{{ $option['clave'] }}" {{ $desenlaceActual === ($option['clave'] ?? '') ? 'selected' : '' }}>
                                        {{ $option['valor'] ?? '' }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="estado" id="estado" class="form-select @error('estado') is-invalid @enderror" required>
                                ...
                                @foreach(($estadoReaccionOptions ?? []) as $option)
                                    <option value="{{ $option['clave'] }}" {{ $estadoActual === ($option['clave'] ?? '') ? 'selected' : '' }}>
                                        {{ $option['valor'] ?? '' }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="observaciones"
                                    ...
                                    rows="3"
                                    placeholder="Notas adicionales...">{{ old('observaciones', $reaccion['observaciones'] ?? '') }}</textarea>
                            @error('observaciones')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <select name="descripcion_consecuencia"
                                ...
                                @foreach(($consecuenciaOptions ?? []) as $option)
                                    <option value="{{ $option['clave'] }}" {{ $descripcionConsecuenciaActual === ($option['clave'] ?? '') ? 'selected' : '' }}>
                                        {{ $option['valor'] ?? '' }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="gravedad" id="gravedad" class="form-select" required>
                                ...
                                @foreach(($gravedadOptions ?? ['LEVE', 'MODERADA', 'GRAVE']) as $opcionGravedad)
                                    <option value="{{ $opcionGravedad }}" {{ old('gravedad', $reaccion['gravedad'] ?? $consecuencias[0]['gravedad'] ?? '') === $opcionGravedad ? 'selected' : '' }}>
...
<script>
    ...
    const reaccionData = @json($reaccion ?? null);
    const detallesData = @json($detalles ?? []);
    const consecuenciasData = @json($consecuencias ?? []);
