...
<div class="container py-2">
    ...
    <?php
        ...
        $descripcionConsecuenciaActual = old('descripcion_consecuencia', $reaccion['descripcion_consecuencia'] ?? $consecuencias[0]['descripcion_consecuencia'] ?? '');
        $descripcionConsecuenciaActual = strtoupper((string) $descripcionConsecuenciaActual);
        $descripcionConsecuenciaActual = str_replace(['Á', 'É', 'Í', 'Ó', 'Ú'], ['A', 'E', 'I', 'O', 'U'], $descripcionConsecuenciaActual);
        $descripcionConsecuenciaActual = preg_replace('/[^A-Z_]/', '', str_replace(' ', '_', $descripcionConsecuenciaActual));
        $desenlaceActual = old('desenlace', $reaccion['desenlace'] ?? '');
        $desenlaceActual = strtoupper((string) $desenlaceActual);
        $desenlaceActual = str_replace(['Á', 'É', 'Í', 'Ó', 'Ú'], ['A', 'E', 'I', 'O', 'U'], $desenlaceActual);
        $desenlaceActual = preg_replace('/[^A-Z_]/', '', str_replace(' ', '_', $desenlaceActual));
        $estadoActual = old('estado', $reaccion['estado'] ?? '');
        $estadoActual = strtoupper((string) $estadoActual);
        $estadoActual = str_replace(['Á', 'É', 'Í', 'Ó', 'Ú'], ['A', 'E', 'I', 'O', 'U'], $estadoActual);
        $estadoActual = preg_replace('/[^A-Z_]/', '', str_replace(' ', '_', $estadoActual));
    ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h3 class="mb-0 fw-black" style="font-weight:900;">
                ...
                Editar Reacción Adversa #<?php echo e($reaccion['id_reaccion'] ?? ''); ?>
    ...
    <div class="form-card p-4">
        <form id="formCrearRAM"
              method="POST"
                            action="<?php echo e(route('reacciones_adversas.update', $reaccion['id_reaccion'])); ?>"
              enctype="multipart/form-data"
              data-unsaved-form="true">
            <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <input type="hidden" name="id_paciente" id="id_paciente" value="<?php echo e(old('id_paciente', $reaccion['id_paciente'] ?? '')); ?>">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="p_numero_expediente" class="form-control" value="<?php echo e(old('numero_expediente', $reaccion['numero_expediente'] ?? 'GENERADO AUTOMATICAMENTE')); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="p_nombre" name="paciente_nombre" class="form-control mayusculas texto-general no-repetidos <?php $__errorArgs = ['paciente_nombre'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('paciente_nombre', $reaccion['nombre_completo'] ?? '')); ?>">
                                <?php $__errorArgs = ['paciente_nombre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" id="p_edad" name="paciente_edad" min="1" max="99" class="form-control <?php $__errorArgs = ['paciente_edad'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('paciente_edad', $reaccion['edad'] ?? '')); ?>">
                                <?php $__errorArgs = ['paciente_edad'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-2">
                                ...
                                <select id="p_sexo" name="paciente_sexo" class="form-select <?php $__errorArgs = ['paciente_sexo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="M" <?php echo e(old('paciente_sexo', $reaccion['sexo'] ?? '') === 'M' ? 'selected' : ''); ?>>MASCULINO</option>
                                    <option value="F" <?php echo e(old('paciente_sexo', $reaccion['sexo'] ?? '') === 'F' ? 'selected' : ''); ?>>FEMENINO</option>
                                    <option value="Otro" <?php echo e(old('paciente_sexo', $reaccion['sexo'] ?? '') === 'Otro' ? 'selected' : ''); ?>>OTRO</option>
                                </select>
                                <?php $__errorArgs = ['paciente_sexo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="p_diagnostico" name="diagnostico_ingreso" rows="2" class="form-control mayusculas texto-general no-repetidos <?php $__errorArgs = ['diagnostico_ingreso'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('diagnostico_ingreso', $reaccion['diagnostico'] ?? '')); ?></textarea>
                                <?php $__errorArgs = ['diagnostico_ingreso'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                ...
                                <select id="notificador" name="notificador" class="form-select <?php $__errorArgs = ['notificador'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="">Seleccione</option>
                                    <option value="MEDICO" <?php echo e(old('notificador', $notificadorActual ?? 'MEDICO') === 'MEDICO' ? 'selected' : ''); ?>>MEDICO</option>
                                    <option value="ENFERMERO" <?php echo e(old('notificador', $notificadorActual ?? 'MEDICO') === 'ENFERMERO' ? 'selected' : ''); ?>>ENFERMERO</option>
                                    <option value="FARMACEUTICO" <?php echo e(old('notificador', $notificadorActual ?? 'MEDICO') === 'FARMACEUTICO' ? 'selected' : ''); ?>>FARMACEUTICO</option>
                                </select>
                                <?php $__errorArgs = ['notificador'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-8 position-relative">
                                ...
                                <input type="text"
                                       ...
                                       autocomplete="off"
                                        value="<?php echo e(old('buscarMedico', $reaccion['nombre_medico'] ?? '')); ?>"
                                       required>
                                    <input type="hidden" id="id_medico" name="id_medico" value="<?php echo e(old('id_medico', $reaccion['id_medico'] ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" id="p_sala" name="sala" class="form-control mayusculas texto-general no-repetidos <?php $__errorArgs = ['sala'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sala', $reaccion['sala'] ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="p_numero_cama" name="numero_cama" class="form-control mayusculas texto-general no-repetidos <?php $__errorArgs = ['numero_cama'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('numero_cama', $reaccion['numero_cama'] ?? '')); ?>" required>
                                <?php $__errorArgs = ['numero_cama'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <div class="col-md-5 position-relative">
                            ...
                            <input type="text" id="buscarMedicamento" name="medicamento_nombre" class="form-control mayusculas texto-general no-repetidos" placeholder="Buscar medicamento..." autocomplete="off" value="<?php echo e(old('medicamento_nombre', $detalles[0]['medicamento'] ?? $detalles[0]['nombre_comercial'] ?? '')); ?>" required>
                            <input type="hidden" name="id_medicamento" id="id_medicamento" value="<?php echo e(old('id_medicamento', $detalles[0]['id_medicamento'] ?? '')); ?>">
                        ...
                        <div class="col-md-3 position-relative">
                            ...
                            <input type="text" id="buscarLote" class="form-control mayusculas texto-general no-repetidos" placeholder="Buscar lote..." autocomplete="off" value="<?php echo e(old('buscarLote', $detalles[0]['numero_lote'] ?? '')); ?>" required>
                            <input type="hidden" name="id_lote" id="id_lote" value="<?php echo e(old('id_lote', $detalles[0]['id_lote'] ?? '')); ?>">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="dosis_posologia" id="dosis_posologia" class="form-control mayusculas texto-general no-repetidos" value="<?php echo e(old('dosis_posologia', $detalles[0]['dosis_posologia'] ?? '')); ?>" placeholder="Ej: 500MG" required>
                        </div>

                        <div class="col-md-2">
                            <label class="form-label">Vía <span class="text-danger">*</span></label>
                            <input type="text" name="via_administracion" id="via_administracion" class="form-control mayusculas texto-general no-repetidos" value="<?php echo e(old('via_administracion', $detalles[0]['via_administracion'] ?? '')); ?>" placeholder="ORAL / IV" required>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" name="fecha_inicio_uso" id="fecha_inicio_uso" class="form-control" value="<?php echo e(old('fecha_inicio_uso', !empty($detalles[0]['fecha_inicio_uso']) ? \Carbon\Carbon::parse($detalles[0]['fecha_inicio_uso'])->toDateString() : '')); ?>" max="<?php echo e(now()->toDateString()); ?>" required>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label">Fin uso (opcional)</label>
                            <input type="date" name="fecha_fin_uso" id="fecha_fin_uso" class="form-control" value="<?php echo e(old('fecha_fin_uso', !empty($detalles[0]['fecha_fin_uso']) ? \Carbon\Carbon::parse($detalles[0]['fecha_fin_uso'])->toDateString() : '')); ?>" min="<?php echo e(old('fecha_inicio_uso', !empty($detalles[0]['fecha_inicio_uso']) ? \Carbon\Carbon::parse($detalles[0]['fecha_inicio_uso'])->toDateString() : '')); ?>">
                        </div>
            ...
            <div class="step" data-step="3" style="display: none;">
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <input type="hidden" name="descripcion_reaccion" id="descripcion_reaccion" value="<?php echo e(old('descripcion_reaccion')); ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date"
                                ...
                                class="form-control <?php $__errorArgs = ['fecha_inicio_reaccion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('fecha_inicio_reaccion', !empty($reaccion['fecha_inicio_reaccion']) ? \Carbon\Carbon::parse($reaccion['fecha_inicio_reaccion'])->toDateString() : '')); ?>"
                                max="<?php echo e(now()->toDateString()); ?>"
                                required>
                            <?php $__errorArgs = ['fecha_inicio_reaccion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date"
                                ...
                                class="form-control <?php $__errorArgs = ['fecha_fin_reaccion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('fecha_fin_reaccion', !empty($reaccion['fecha_fin_reaccion']) ? \Carbon\Carbon::parse($reaccion['fecha_fin_reaccion'])->toDateString() : '')); ?>"
                                min="<?php echo e(old('fecha_inicio_reaccion', !empty($reaccion['fecha_inicio_reaccion']) ? \Carbon\Carbon::parse($reaccion['fecha_inicio_reaccion'])->toDateString() : '')); ?>">
                            <?php $__errorArgs = ['fecha_fin_reaccion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <select
                                name="desenlace"
                                id="desenlace"
                                class="form-select <?php $__errorArgs = ['desenlace'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = ($desenlaceOptions ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($option['clave']); ?>" <?php echo e($desenlaceActual === ($option['clave'] ?? '') ? 'selected' : ''); ?>>
                                        <?php echo e($option['valor'] ?? ''); ?>

                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['desenlace'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="">Seleccione una opción</option>
                                <?php $__currentLoopData = ($estadoReaccionOptions ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($option['clave']); ?>" <?php echo e($estadoActual === ($option['clave'] ?? '') ? 'selected' : ''); ?>>
                                        <?php echo e($option['valor'] ?? ''); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="observaciones"
                                    id="observaciones"
                                    class="form-control mayusculas texto-general no-repetidos <?php $__errorArgs = ['observaciones'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    rows="3"
                                    placeholder="Notas adicionales..."><?php echo e(old('observaciones', $reaccion['observaciones'] ?? '')); ?></textarea>
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <select name="descripcion_consecuencia"
                                    ...
                                    class="form-select">
                                <option value="">Seleccione una opción</option>
                                <?php $__currentLoopData = ($consecuenciaOptions ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($option['clave']); ?>" <?php echo e($descripcionConsecuenciaActual === ($option['clave'] ?? '') ? 'selected' : ''); ?>>
                                        <?php echo e($option['valor'] ?? ''); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="gravedad" id="gravedad" class="form-select" required>
                                ...
                                <?php $__currentLoopData = ($gravedadOptions ?? ['LEVE', 'MODERADA', 'GRAVE']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opcionGravedad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($opcionGravedad); ?>" <?php echo e(old('gravedad', $reaccion['gravedad'] ?? $consecuencias[0]['gravedad'] ?? '') === $opcionGravedad ? 'selected' : ''); ?>>
                                        <?php echo e(str_replace('_', ' ', $opcionGravedad)); ?>
...
<script>
    const pendingTrayData = <?php echo json_encode($pendienteSeleccionado ?? null, 15, 512) ?>;
    const selectedPacienteData = <?php echo json_encode($pacienteSeleccionado ?? null, 15, 512) ?>;
    const personalClinicoData = <?php echo json_encode($personalClinico ?? [], 15, 512) ?>;
    const reaccionData = <?php echo json_encode($reaccion ?? null, 15, 512) ?>;
    const detallesData = <?php echo json_encode($detalles ?? [], 15, 512) ?>;
    const consecuenciasData = <?php echo json_encode($consecuencias ?? [], 15, 512) ?>;
    ...
    (function precargarEdicion() {
        if (!reaccionData || typeof reaccionData !== 'object') return;

        const detalle = Array.isArray(detallesData) && detallesData.length ? detallesData[0] : {};
        const consecuencia = Array.isArray(consecuenciasData) && consecuenciasData.length ? consecuenciasData[0] : {};

        const setIfEmpty = (id, value) => {
            const el = document.getElementById(id);
            if (!el) return;
            if (!String(el.value || '').trim() && value !== null && value !== undefined && String(value).trim() !== '') {
                el.value = String(value);
            }
        };

        setIfEmpty('p_numero_expediente', reaccionData.numero_expediente);
        setIfEmpty('id_paciente', reaccionData.id_paciente);
        setIfEmpty('p_nombre', reaccionData.nombre_completo);
        setIfEmpty('p_edad', reaccionData.edad);
        setIfEmpty('p_sexo', reaccionData.sexo);
        setIfEmpty('p_diagnostico', reaccionData.diagnostico);
        setIfEmpty('id_medico', reaccionData.id_medico);
        setIfEmpty('p_sala', reaccionData.sala);
        setIfEmpty('p_numero_cama', reaccionData.numero_cama);

        setIfEmpty('buscarMedicamento', detalle.medicamento || detalle.nombre_comercial);
        setIfEmpty('id_medicamento', detalle.id_medicamento);
        setIfEmpty('buscarLote', detalle.numero_lote);
        setIfEmpty('id_lote', detalle.id_lote);
        setIfEmpty('dosis_posologia', detalle.dosis_posologia);
        setIfEmpty('via_administracion', detalle.via_administracion);
        setIfEmpty('fecha_inicio_uso', detalle.fecha_inicio_uso ? String(detalle.fecha_inicio_uso).slice(0, 10) : '');
        setIfEmpty('fecha_fin_uso', detalle.fecha_fin_uso ? String(detalle.fecha_fin_uso).slice(0, 10) : '');

        setIfEmpty('descripcion_reaccion', reaccionData.descripcion_reaccion);
        setIfEmpty('fecha_inicio_reaccion', reaccionData.fecha_inicio_reaccion ? String(reaccionData.fecha_inicio_reaccion).slice(0, 10) : '');
        setIfEmpty('fecha_fin_reaccion', reaccionData.fecha_fin_reaccion ? String(reaccionData.fecha_fin_reaccion).slice(0, 10) : '');
        setIfEmpty('desenlace', reaccionData.desenlace);
        setIfEmpty('estado', reaccionData.estado);
        setIfEmpty('observaciones', reaccionData.observaciones);

        setIfEmpty('descripcion_consecuencia', reaccionData.descripcion_consecuencia || consecuencia.descripcion_consecuencia);
        setIfEmpty('gravedad', reaccionData.gravedad || consecuencia.gravedad);

        const buscarMedicoInput = document.getElementById('buscarMedico');
        const idMedicoInput = document.getElementById('id_medico');
        const notificadorInput = document.getElementById('notificador');
        if (buscarMedicoInput && idMedicoInput && idMedicoInput.value && !buscarMedicoInput.value.trim()) {
            const medico = personalClinicoData.find((m) => String(m.id_medico) === String(idMedicoInput.value));
            if (medico) {
                buscarMedicoInput.value = `${medico.nombre_completo ?? 'MEDICO'}${medico.numero_colegiacion ? ' - ' + medico.numero_colegiacion : ''}`;
                if (notificadorInput && !notificadorInput.value && medico.rol_nombre) {
                    notificadorInput.value = String(medico.rol_nombre).toUpperCase();
                }
            }
        }

        const precargarImagenGuardada = (ruta, previewId, placeholderId, fileNameId) => {
            if (!ruta) return;

            const preview = document.getElementById(previewId);
            const placeholder = document.getElementById(placeholderId);
            const fileName = document.getElementById(fileNameId);
            if (!preview || !placeholder || !fileName) return;

            const rutaNormalizada = String(ruta).startsWith('http')
                ? String(ruta)
                : `${apiBaseUrl}/uploads/${String(ruta).replace(/^\/+/, '')}`;

            preview.src = rutaNormalizada;
            preview.classList.remove('d-none');
            placeholder.classList.add('d-none');
            fileName.textContent = `Archivo guardado: ${String(ruta).split('/').pop()}`;
            fileName.classList.remove('d-none');
        };

        precargarImagenGuardada(reaccionData.ruta_foto_medicamento, 'previewImageMedicamento', 'uploadPlaceholderMedicamento', 'fileNameMedicamento');
        precargarImagenGuardada(reaccionData.ruta_foto_evidencia, 'previewImageEvidencia', 'uploadPlaceholderEvidencia', 'fileNameEvidencia');
    })();
    ...
    function validarCamposObligatorios() {
        ...
        const usaPacienteExistente = !!idPaciente.value.trim();
    ...
    async function buscarMedicamentos(q) {
        const res = await fetch(`<?php echo e(route('ajax.medicamentos')); ?>?q=${encodeURIComponent(q)}`);
        return await res.json();
    }

    async function buscarLotes(q, idMedicamento) {
        const res = await fetch(`<?php echo e(route('ajax.lotes')); ?>?q=${encodeURIComponent(q)}&id_medicamento=${encodeURIComponent(idMedicamento || '')}`);
        return await res.json();
    }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mrner\Escritorio\PROYECTO\Sistema HE\ProyectoHospitalEscuela\Frontend\resources\views/reacciones_adversas/edit.blade.php ENDPATH**/ ?>