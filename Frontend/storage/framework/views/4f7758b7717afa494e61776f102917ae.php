...
<link rel="stylesheet" href="<?php echo e(asset('login-assets/vendor/bootstrap/css/bootstrap.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('login-assets/fonts/font-awesome-4.7.0/css/font-awesome.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('login-assets/fonts/Linearicons-Free-v1.0.0/icon-font.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('login-assets/vendor/animate/animate.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('login-assets/vendor/css-hamburgers/hamburgers.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('login-assets/vendor/animsition/css/animsition.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('login-assets/vendor/select2/select2.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('login-assets/vendor/daterangepicker/daterangepicker.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('login-assets/css/main.css')); ?>">
...
<body>
<div class="limiter">
    <div class="container-login100" style="background-image: url('<?php echo e(asset('login-assets/images/bg-01.jpg')); ?>');">
        <div class="wrap-login100 p-t-30 p-b-50">
            <form id="register-form" class="login100-form validate-form p-b-33 p-t-5">
                ...
                <div style="text-align:center;margin-bottom:20px;">
                    <img src="<?php echo e(asset('login-assets/images/logo-circle.png')); ?>" width="120">
                </div>
                ...
                <div class="container-login100-form-btn">
                    <a class="login100-form-btn" href="<?php echo e(url('/login')); ?>" style="text-decoration:none; display:flex; justify-content:center;">Volver al Login</a>
                </div>
            </form>
        </div>
    </div>
...
<script src="<?php echo e(asset('login-assets/vendor/jquery/jquery-3.2.1.min.js')); ?>"></script>
<script src="<?php echo e(asset('login-assets/vendor/animsition/js/animsition.min.js')); ?>"></script>
<script src="<?php echo e(asset('login-assets/vendor/bootstrap/js/popper.js')); ?>"></script>
<script src="<?php echo e(asset('login-assets/vendor/bootstrap/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('login-assets/vendor/select2/select2.min.js')); ?>"></script>
<script src="<?php echo e(asset('login-assets/vendor/daterangepicker/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('login-assets/vendor/daterangepicker/daterangepicker.js')); ?>"></script>
<script src="<?php echo e(asset('login-assets/vendor/countdowntime/countdowntime.js')); ?>"></script>
<script src="<?php echo e(asset('login-assets/js/main.js')); ?>"></script>
<script src="<?php echo e(asset('login-assets/js/unsaved-guard.js')); ?>"></script>
...
<?php /**PATH C:\Users\Pao\OneDrive\Escritorio\Sistema HE\ProyectoHospitalEscuela\Frontend\resources\views/auth/register.blade.php ENDPATH**/ ?>